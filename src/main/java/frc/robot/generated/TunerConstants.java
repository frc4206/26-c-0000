...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Limits current drawn from the battery
                .withSupplyCurrentLimit(Amps.of(30))
                .withSupplyCurrentLimitEnable(true)

                // Limits current inside the motor (torque)
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Steer motors need much less power than drive motors
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.30615234375);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.14697265625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.10791015625);
